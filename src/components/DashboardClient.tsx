                ...
                {safePlannedWorkouts.map((workout: any) => (
                  <li key={workout.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between bg-white/80 rounded-xl p-3 border border-white/40 shadow-sm">
                    ...
                    <Link
                      ...
                      className="mt-2 sm:mt-0 sm:ml-4 bg-gradient-to-r from-yellow-400 via-orange-400 to-pink-500 text-white font-bold py-2 px-4 rounded-full shadow hover:scale-105 transition-transform text-sm text-center"
                    >
                      Démarrer
                    </Link>
                  </li>
